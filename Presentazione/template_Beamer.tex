...
\begin{frame}
	...
	\begin{itemize}
		...
		\item  \textbf{approssimated:} Simile alla varaibile precedente. Varia per due motivi: si considera in valore assoluto ed assume valore pari a 0 se la differenza è inferiore a 10 (pixel). 
