...
\begin{frame}
	...
	L'analisi posturale statica \'e un esame in grado di diagnosticare diversi disturbi della postura e non solo.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Pulizia delle immagini (rimozione del tracciato del baricentro).
